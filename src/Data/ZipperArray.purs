-- | Moduled copied from
-- | [jamieyung/purescript-zipperarray](https://github.com/jamieyung/purescript-zipperarray),
-- | because it's not in the package set.
...
snoc :: forall a. ZipperArray a -> a -> ZipperArray a
snoc (Private_ arr i cur) x = Private_ (NEA.snoc arr x) i cur
